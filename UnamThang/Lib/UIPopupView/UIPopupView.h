...
@property (nonatomic, copy) void (^mainViewTapListner)(UIPopupView *);
@property (nonatomic, copy) void (^backgroundViewTapListner)(UIPopupView *);
...
@property (nonatomic, assign) UITextAlignment informationTextAlignment;
